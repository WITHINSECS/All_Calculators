        ...
        <Wrapper>
            ...
            <div className="md:mb-16 my-6 max-w-5xl mx-auto p-4">
                <div className="flex flex-col gap-6">
                    ...
                    <div className="md:w0%] space-y-6 w-full">
                        <div>
                            <Label className='black mb-2' htmlFor="salary">What is your annual salary?</Label>
                            <Input
                                type="number"
                                id="salary"
                                value={salary}
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="monthlyContribution">How much do you contribute each month?</Label>
                            <Slider
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="salaryIncrease">How much will your salary rise each year?</Label>
                            <Input
                                type="number"
                                id="salaryIncrease"
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="currentAge">How old are you?</Label>
                            <Input
                                type="number"
                                id="currentAge"
                                value={currentAge}
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="retirementAge">What age do you want to retire at?</Label>
                            <Input
                                type="number"
                                id="retirementAge"
                                value={retirementAge}
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="rateOfReturn">What is your expected rate of return?</Label>
                            <Input
                                type="number"
                                id="rateOfReturn"
                                value={rateOfReturn}
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="current401k">Current 401(k) balance</Label>
                            <Input
                                type="number"
                                id="current401k"
                                value={current401k}
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="employerMatch">Employer match</Label>
                            <Slider
                        ...
                        <div>
                            <Label className='black mb-2' htmlFor="salaryLimit">Salary limit for employer match</Label>
                            <Slider
