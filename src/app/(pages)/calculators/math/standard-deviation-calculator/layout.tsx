...
export async function generateMetadata(): Promise<Metadata> {
    return getCalculatorPageMetadata("math/standard-deviation-calculator");
}
...
export default async function CalculatorRouteLayout({
    ...
    const item = await getCachedCalculatorPageContentSafe("math/standard-deviation-calculator");
