                ...
                {result && (
                    <div className="mt-8">
                        ...
                        <div className="text-lg">
                            ...
                            <p>Performance: {result.vo2Max > 50 ? "Excellent" : result.vo2Max > 40 ? "Good" : result.vo2Max > 30 ? "Average" : result.vo2Max > 20 ? "Below Average" : "Poor"}</p>
                        </div>
