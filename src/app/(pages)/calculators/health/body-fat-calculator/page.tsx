...
export default function BodyFatCalculator() {
    ...
    const [neckSize, setNeckSize] = useState(10);
    const [waistSize, setWaistSize] = useState(100);
    ...
    const calculateBodyFat = () => {
        if (weight === 0 || height === 0 || waistSize === 0 || neckSize === 0 || age === 0) {
        ...
        if (gender === "Male") {
            ...
            bodyFatPercentage = 163.205 * Math.log10(waistSize + 0) - 78.387 * Math.log10(height);
        }
        ...
        <Wrapper>
            <div className="container mx-auto p-5 lg:px-12 md:my-14 my-8">
                <div className="mx-auto max-w-3xl text-center mb-8">
                    <h1 className="text-2xl font-semibold lg:text-4xl">Body Fat Calculator</h1>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="grid gap-4">
                            ...
                            <div className="flex flex-col">
                                <Label className="block mb-1.5" htmlFor="height">Height (cm)</Label>
                                <Input
                                    id="height"
                                    type="number"
                                    value={height}
                            ...
                            <div className="flex flex-col">
                                <Label className="block mb-1.5" htmlFor="neckSize">Neck Size (cm)</Label>
                                <Input
                                    id="neckSize"
                                    type="number"
                                    value={neckSize}
                                    onChange={(e) => setNeckSize(Number(e.target.value))}
                                    placeholder="Enter your neck size"
                                />
                            </div>
                            <div className="flex flex-col">
                                <Label className="block mb-1.5" htmlFor="waistSize">Waist Size (cm)</Label>
                                <Input
                                    id="waistSize"
                                    type="number"
                                    value={waistSize}
                            ...
                            <div className="flex justify-center mt-4">
                                <Button className="w-full" onClick={calculateBodyFat}>Calculate</Button>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell>{bodyFatResult.bodyFatPercentage}%</TableCell>
                                        </TableRow>
                                        <TableRow>
                                    ...
                                    <PieContainer width="100%" height={300}>
                                        <PieChart>
                                            <Pie
                                                ...
                                                cy="50%"
                                                outerRadius={80}
                                                fill="#ff7300" // Adjust color for fat mass
                                                label
                                            >
