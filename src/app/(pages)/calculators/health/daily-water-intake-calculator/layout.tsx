...
export async function generateMetadata(): Promise<Metadata> {
    return getCalculatorPageMetadata("health/daily-water-intake-calculator");
}
...
export default async function CalculatorRouteLayout({
    ...
    const item = await getCachedCalculatorPageContentSafe("health/daily-water-intake-calculator");
