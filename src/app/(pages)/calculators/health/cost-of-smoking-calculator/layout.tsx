...
export async function generateMetadata(): Promise<Metadata> {
    return getCalculatorPageMetadata("health/cost-of-smoking-calculator");
}
...
export default async function CalculatorRouteLayout({
    ...
    const item = await getCachedCalculatorPageContentSafe("health/cost-of-smoking-calculator");
