...
export async function generateMetadata(): Promise<Metadata> {
    return getCalculatorPageMetadata("lifestyle/steps-to-miles-calculator");
}
...
export default async function CalculatorRouteLayout({
    ...
    const item = await getCachedCalculatorPageContentSafe("lifestyle/steps-to-miles-calculator");
