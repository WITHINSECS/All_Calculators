...
export async function generateMetadata(): Promise<Metadata> {
    return getCalculatorPageMetadata("lifestyle/ev-travel-cost-calculator");
}
...
export default async function CalculatorRouteLayout({
    ...
    const item = await getCachedCalculatorPageContentSafe("lifestyle/ev-travel-cost-calculator");
